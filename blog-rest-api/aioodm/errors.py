"""AioOdm errors and exceptions."""
import re

import pymongo.errors

from aioodm.utils import _Empty


class AioOdmException(Exception):
    """Base AioOdm Exception class."""


class Error(AioOdmException):
    """Base AioOdm Error class."""
...
class StopValidation(AioOdmException):
