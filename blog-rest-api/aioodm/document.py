...
from aioodm.errors import ValidationError
from aioodm.queryset import MotorQuerySet
from aioodm.fields import Field, ObjectIdField, SynonymField, _Empty
from aioodm.utils import snake_case
...
class ValidatingDocument(Document):
    """A document with hooks for validation"""

    async def _invoke(self, can_validate, pre_action, action, post_action, *args, **kwargs):
        await pre_action()

        if can_validate and kwargs.pop('validate', True):
            self.validate()
    ...
    async def save(self, *args, **kwargs):
        ...
        .. note::
            ...
            Calls pre_save before saving and post_save afterwards.
        ...
        Args:
            ...
            do_insert (bool): If ``True`` always perform ``insert_one``, else
                perform ``replace_one`` with ``upsert=True``.
        """
        return await self._invoke(True, self.pre_save, super().save, self.post_save, *args, **kwargs)
    ...
    async def update(self, *args, **kwargs):
        ...
        .. note::
            Validates the document before saving.
            Calls pre_update before updating and post_update afterwards.
        ...
        """
        return await self._invoke(True, self.pre_update, super().update, self.post_update, *args, **kwargs)
    ...
    async def delete(self, *args, **kwargs):
        ...
        .. note::
            Calls pre_delete before deleting and post_delete afterwards.
        """

        return await self._invoke(False, self.pre_delete, super().delete, self.post_delete, *args, **kwargs)
    ...
    def from_mongo(cls, data):
        ...
        Returns:
            Document instance.
        """
        cls.pre_from_mongo(data)
        inst = super().from_mongo(data)
        cls.post_from_mongo(inst)
        return inst

    @classmethod
    def pre_from_mongo(cls, data):
        pass

    @classmethod
    def post_from_mongo(cls, data):
        pass
    ...
    def from_data(cls, data):
        ...
        Returns:
            Document instance.
        """
        cls.pre_from_data(data)
        inst = super().from_data(data)
        cls.post_from_data(inst)
        return inst

    @classmethod
    def pre_from_data(cls, data):
        pass

    @classmethod
    def post_from_data(cls, data):
        pass
